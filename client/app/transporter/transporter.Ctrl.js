(function() {
  ...
  angular
    .module('app')
    .controller('TransporterCtrl', TransporterCtrl);

  TransporterCtrl.$inject = ['$scope', 'Auth', '$modal', 'transporterAPI', '$alert', 'looksAPI'];

  function TransporterCtrl($scope, Auth, $modal, transporterAPI, $alert, looksAPI) {
    ...
    $scope.deleteUser = function(user) {
      transporterAPI.deleteUser(user)
        .then(function(data) {
